...
METALLB_IMAGE ?= $$(curl -sL https://download.fedoraproject.org/pub/fedora/linux/releases/41/Cloud/x86_64/images/ | grep -oE 'Fedora-Cloud-Base-Generic-[^"]+\.qcow2' | head -n1 | xargs -I{} echo "https://download.fedoraproject.org/pub/fedora/linux/releases/41/Cloud/x86_64/images/{}")
